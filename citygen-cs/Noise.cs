...
namespace citygen_cs
{
    public class Noise
    {
        ...
        private static Grad[] gradP = new Grad[512];

        private static double F2 = 0.5 * (Math.Sqrt(3) - 1);
        private static double G2 = (3 - Math.Sqrt(3)) / 6;
        ...
        public static double Simplex2(double xin, double yin)
        {
            double n0, n1, n2;
